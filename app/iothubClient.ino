...
static void sendMessage(IOTHUB_CLIENT_LL_HANDLE iotHubClientHandle, char *buffer, bool hourlyUpdate)
{
    ...
    else
    {
        ...
        Map_Add(properties, "hourlyUpdate", hourlyUpdate ? "true" : "false");
